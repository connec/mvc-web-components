...
* be launched soon.
*
* Modified for E_STRICT standards by Chris Connelly for MVC project.
* 
...
class Inflector
{
    ...
    */
    ...
    /**
    * Converts an underscored or CamelCase word into an English
    * sentence.
    * 
    * The titleize function converts text like "WelcomePage",
    * "welcome_page" or  "welcome page" to "Welcome
    * Page".
